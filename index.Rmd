...
* Data by zip code from 2006-2010 ACS that includes Mean Income, Median Income, and Population for each zip code
...
The two main errors were: 
  ...
  * `on_scene` (Red Cross arrives at the incident) time stamps LATER than `dispatched` (Red Cross hears about incident and sends volunteers). This doesn't make any sense.
