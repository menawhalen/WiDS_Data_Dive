...
* Shapefile for zip codes in Chicago, and a [spatial data cleaning R script](#spatial-data) that merges this with any outside csv (Red Cross or Census) based on zip code
...
```{r basicclean}
library(RCurl)
red_cross<-getURL("https://raw.githubusercontent.com/menawhalen/WiDS_Data_Dive/master/Redcross.csv")
