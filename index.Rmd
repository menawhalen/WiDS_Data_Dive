...
<<<<<<< HEAD
ggplot(test, aes(month, n)) + geom_line() + xlab("") + ylab("Monthly Incidents") + ggtitle('Monthly Incidents responded to by the Chicago/Northern Illinois Red Cross \n 2014-2018') +  geom_smooth(method = "loess", size = 1.5, se=FALSE)
=======
...
* Shapefile for zip codes in Northern Illinois, and an example [spatial mapping R script](#spatial-data) 
