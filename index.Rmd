...
ggplot(test, aes(month, n)) + geom_line() + xlab("") + ylab("Monthly Incidents") + ggtitle('Monthly Incidents responded to by the Chicago/Northern Illinois Red Cross, 2014-2018') +  geom_smooth(method = "loess", size = 1.5, se=FALSE)
